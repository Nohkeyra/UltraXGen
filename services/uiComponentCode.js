  ...
  return (
    <div className="p-4 bg-gray-50 border-t border-gray-200 sticky bottom-0 z-10 flex flex-col md:flex-row items-center gap-2">
      ...
      <button
        ...
        className={\`px-6 py-2 rounded-lg text-white font-semibold transition duration-150 ease-in-out w-full md) ? 'bg-blue-300 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50'}\`}
      >
        {isLoading ? (
