...
export const LogViewer = ({ logs, onClear, isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4 sm:p-10 animate-in fade-in duration-300">
      ...
      <div className="relative w-full max-w-4xl h-full max-h-[600px] bg-brandCharcoal dark,0,1,0.3)] flex flex-col overflow-hidden rounded-sm">
